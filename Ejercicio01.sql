...
VALUES (1, 'pepe', 10), (2, 'paco', 20), (3, 'maria', 30), (4,'ana', 40)
...
ADD COLUMN Fecha_Min DATE NULL
/*19.	Agregar una clave externa a la tabla "Pedidos" que haga referencia a la tabla "Productos" en la columna "producto".*/
ALTER TABLE pedidos
ADD CONSTRAINT foreign_key_pedidos FOREIGN KEY producto REFERENCES producto(nombre);
